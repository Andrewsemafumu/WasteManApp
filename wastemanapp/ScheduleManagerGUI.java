...
public class ScheduleManagerGUI extends javax.swing.JFrame  {
    ...
    /**
     * Creates new form ScheduleManagerGUI
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScheduleManagerGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScheduleManagerGUI().setVisible(true);
            }
        });
    }
